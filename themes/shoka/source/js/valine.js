          ...
          try {
              ...
              var v = (0 == e.config.meta.length
                  ...
                  return h.defaultMeta.indexOf(t) > -1
                    ? '<input name="' +
                        ...
                        '" placeholder="' +
                        e.i18n.t(t) +
                        (e.config.requiredFields.indexOf(t) > -1
                          ? e.i18n.t("required")
                          : "") +
                        '" class="v' +
                        t +
                ...
                g =
                  ...
                  '"></textarea><div class="vrow"><div class="vcol vcol-70 status-bar">' +
                  e.config.tips +
                  '</div><div class="vcol vcol-30 vctrl text-right"><span title="' +
                  e.i18n.t("emoji") +
                  ...
                  e.i18n.t("preview") +
                  '" class="vicon vpreview-btn"><svg  viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="17688" width="22" height="22"><path d="M502.390154 935.384615a29.538462 29.538462 0 1 1 0 59.076923H141.430154C79.911385 994.461538 29.538462 946.254769 29.538462 886.153846V137.846154C29.538462 77.745231 79.950769 29.538462 141.390769 29.538462h741.218462c61.44 0 111.852308 48.206769 111.852307 108.307692v300.268308a29.538462 29.538462 0 1 1-59.076923 0V137.846154c0-26.899692-23.355077-49.230769-52.775384-49.230769H141.390769c-29.420308 0-52.775385 22.331077-52.775384 49.230769v748.307692c0 26.899692 23.355077 49.230769 52.775384 49.230769h360.999385z" p-id="17689"></path><path d="M196.923077 216.615385m29.538461 0l374.153847 0q29.538462 0 29.538461 29.538461l0 0q0 29.538462-29.538461 29.538462l-374.153847 0q-29.538462 0-29.538461-29.538462l0 0q0-29.538462 29.538461-29.538461Z" p-id="17690"></path><path d="M649.846154 846.769231a216.615385 216.615385 0 1 0 0-433.230769 216.615385 216.615385 0 0 0 0 433.230769z m0 59.076923a275.692308 275.692308 0 1 1 0-551.384616 275.692308 275.692308 0 0 1 0 551.384616z" p-id="17691"></path><path d="M807.398383 829.479768m20.886847-20.886846l0 0q20.886846-20.886846 41.773692 0l125.321079 125.321079q20.886846 20.886846 0 41.773693l0 0q-20.886846 20.886846-41.773693 0l-125.321078-125.321079q-20.886846-20.886846 0-41.773693Z" p-id="17692"></path></svg></span></div></div></div><div class="vrow"><div class="vcol vcol-30" ><a alt="Markdown is supported" href="https://guides.github.com/features/mastering-markdown/" class="vicon" target="_blank"><svg class="markdown" viewBox="0 0 16 16" version="1.1" width="16" height="16" aria-hidden="true"><path fill-rule="evenodd" d="M14.85 3H1.15C.52 3 0 3.52 0 4.15v7.69C0 12.48.52 13 1.15 13h13.69c.64 0 1.15-.52 1.15-1.15v-7.7C16 3.52 15.48 3 14.85 3zM9 11H7V8L5.5 9.92 4 8v3H2V5h2l1.5 2L7 5h2v6zm2.99.5L9.5 8H11V5h2v3h1.5l-2.51 3.5z"></path></svg></a></div><div class="vcol vcol-70 text-right"><button type="button"  title="Cmd|Ctrl+Enter" class="vsubmit vbtn button">' +
                  e.i18n.t("submit") +
                  '</button></div></div><div class="vemojis" style="display:none;"></div><div class="vinput vpreview md" style="display:none;"></div><div style="display:none;" class="vmark"></div></div></div><div class="vcount" style="display:none;"><span class="vnum">0</span> ' +
                  e.i18n.t("comments") +
                  '</div><div class="vload-top text-center" style="display:none;"><i class="vspinner" style="width:30px;height:30px;"></i></div><div class="vcards"></div><div class="vload-bottom text-center" style="display:none;"><i class="vspinner" style="width:30px;height:30px;"></i></div><div class="vempty" style="display:none;"></div><div class="vpage text-center" style="display:none"><button type="button" class="vmore vbtn button">' +
                  e.i18n.t("more") +
                  "</button></div>";
              e.$el.html(g),
            ...
            (0, k.default)(e.config, function (t) {
              ...
              !(function o(t) {
                var n = t[r++];
                if (n) {
                  var i = (0, y.default)(n).attr("data-xid");
                  !!i &&
                    e
                      .Q(i)
                      .count()
      ...
      (o.prototype.Q = function (e) {
        ...
        (o.prototype.bind = function () {
          ...
          var C = function (t, n, r) {
              ...
              var l = t.get("link")
                ...
                d =
                  ...
                  c +
                  (e.config.masters.includes(md5(t.get("mail"))) &&
                  e.config.masterTag
                  ...
                  '">' +
                  e.i18n.t("reply") +
                  '</span></div><div class="vcontent md" data-expand="' +
                  e.i18n.t("expand") +
                  '">' +
          ...
          var changeTips = function (tip, show) {
              e.$el
                .find(".status-bar")
                .html("" + show === true ? tip : e.i18n.t(tip))
                .addClass("warning")
            ...
            L = function (t) {
              if (
                ...
                return v.nick[0].focus(), void changeTips("nickFail");
              if (
                e.config.requiredFields.indexOf("mail") > -1 &&
                !/[\w-\.]+@([\w-]+\.)+[a-z]{2,3}/.test(E.mail)
              )
                return v.mail[0].focus(), void changeTips("mailFail");
                  ...
                  Q(o, function (s) {
                    500 != s.code
                      ? (i.val(
                        ...
                        (0, c.default)(i[0]),
                        ++n < r ? D(t, n) : z.removeAttr("disabled"))
                      : (i.val(i.val().replace(a, "")),
                        (0, c.default)(i[0]),
